...
```bash
git clone https://github.com/AmandaFelix-dev/mobile-projects.git
# ou se estiver utilizando chave SSH
git clone git@github.com:AmandaFelix-dev/mobile-projects.git
```
...
Para obter mais informações sobre o projeto navegue pela aplicação e dê uma olhadinha no nosso [repositório](https://github.com/AmandaFelix-dev/mobile-projects.git).
